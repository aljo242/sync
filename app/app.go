...
type App struct {
	*baseapp.BaseApp
	...
	SyncKeeper syncmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.SyncKeeper = *syncmodulekeeper.NewKeeper(
		appCodec,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(syncmoduletypes.ModuleName)
